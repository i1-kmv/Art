...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_sliders__WEBPACK_IMPORTED_MODULE_1__["default"])('.main-slider-item', 'vertikal');
});
...
var sliders = function sliders(slides, dir, prev, next) {
  //Устанавливаем первый слайд, который видит пользователь при переходу на страницу
  var slideIndex = 1,
      paused = false; // Определяем все элементы слайдера  

  var items = document.querySelectorAll(slides); // Создаем функцию, которая будет отвечать за перемещение слайдов и изменение слайдиндекса  
